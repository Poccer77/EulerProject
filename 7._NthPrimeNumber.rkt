...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 7._NthPrimeNumber) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;; n-th prime number
